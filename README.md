...
| `jira-release` | Jira fix version manager. Use when the user asks to assign work to a Jira fix version, or which fix versions the project has and what state each is in.     | [read](docs/skills/jira-release.md) |
