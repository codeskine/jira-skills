...
| refine              | acceptance criteria, on every item the refinement leaves behind; a scope small enough to be finished; dependencies named as links; the raw declaration retired, where the item carried one |
